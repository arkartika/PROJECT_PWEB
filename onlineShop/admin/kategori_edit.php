...
$sql = "SELECT nama_kategori FROM kategori where id_kategori ='$id'";
$query = mysqli_query($con,$sql);
    ...
    <div class="card-body">
        <form method="post" action="">
            <div class="form-group">
                ...
                <input type="text" name = "nama" value="<?=$data['nama_kategori'];?>" class="form-control" placeholder="Nama Kategori" require>
            </div>
            <div class="form-group">
